...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options) -> None:
        ...
        logger.info(
            "Loading dependent tables tables: geographies and geography-program match, and census tracts"
        )
        ...
        for job in jobs:
            ...
            while (
                True
            ):  # See django docs here for pattern, https://docs.djangoproject.com/en/4.2/ref/models/querysets/#bulk-create
