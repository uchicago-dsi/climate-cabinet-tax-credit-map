...
def save_data(
    cleaned_data: pd.DataFrame or gpd.GeoDataFrame, output_path: str, type: str
) -> None:
    """
...
def data_preprocess(
    ...
    cols_drop: list or None = None,
    cols_to_keep: list or None = None,
    cols_rename: dict or None = None,
