...
class SummaryBuilder {
  ...
  #describeBonusDems(bonusGeos, singleType, pluralType) {
    ...
    return `${this.#formatNum(numGeos)} ${typeName} with a ` +
  ...
  if (!reportSnap.report?.geographies) {
    return (
      <div className="text-slate-400 font-medium text-center">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={0.5} stroke="gray" className="w-12 h-12 block m-auto">
    ...
    <div>
      <div>
        ...
        <h4>
          ...
          {builder.targetPop}<br />
        </h4>
        <div>
          <h4><b>Bonus Territories</b></h4>
          <span>
