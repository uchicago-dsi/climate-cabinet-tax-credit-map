  ...
  return (
    <div className="px-20">
      <div className="flex w-full pt-10">
        <div className="grid grid-cols-8 m-0 min-h-[75vh]" id="report-widget">
          {/** MAP */}
          ...
          <div
            className={
              "col-span-2 flex flex-col w-full h-full px-5 bg-white border-2 border-slate-100 text-xl overflow-y-auto scrollbar " +
